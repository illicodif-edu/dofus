...
public class Main{
	public static void main(String args[]) {
		...
		Fighter nestOfSnakes = new Fighter("Nest of Snakes",venom, noArmor, noShield, new Treasure(1, 0, 0,0), 12, "src\\com\\dofus\\snaket.png");
		...
		Fighter dragon = new Fighter("Dragon",claws, skin, noShield, new Treasure(0, 1, 1, 3), 25, "src\\com\\dofus\\dragon.jpg");
		Fighter doppleganger = new Fighter("Dopple Ganger",null, null, heavyShield, null, 0, "src\\com\\dofus\\art_cra.png");
		Fighter wizard = new Fighter("The wizard",lightningBolts, magicAura, null, new Treasure(0, 0, 3, 0), 150, "src\\com\\dofus\\wizard.jpg");
